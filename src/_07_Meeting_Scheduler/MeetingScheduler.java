...
public class MeetingScheduler {
	...
	public static Schedule getMutualAvailability(Schedule person1, Schedule person2) {
		...
		HashMap<String, ArrayList<Integer>> Person1 = person1.getSchedule();
		HashMap<String, ArrayList<Integer>> Person2 = person2.getSchedule();
		for (String s : Person1.keySet()) {	
			
			ArrayList<Integer> monday1 = Person1.get(s);
			ArrayList<Integer> monday2 = Person2.get(s);
			for (int i = 0; i < monday1.size(); i++) {
				int t = monday1.get(i);
				System.out.println(t);

				if (monday2.contains(t)) {
					schedule.addAvailability(s, t);
				}
			}
		}
